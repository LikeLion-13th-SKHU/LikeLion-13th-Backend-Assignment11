package com.likelion.multipartfile_prac.member.application;
...
import com.likelion.multipartfile_prac.image.application.ImageService;
import com.likelion.multipartfile_prac.member.domain.Member;
import com.likelion.multipartfile_prac.member.domain.repository.MemberRepository;
...
public class MemberService {
    ...
    // 사용자 생성
    @Transactional
    public MemberResDto createMember(String name, String email, MultipartFile imageFile) {
        ...
        ImageResDto imageResDto = null;
        if (savedImage != null) {
            imageResDto = new ImageResDto(
                    savedImage.getId(),
    ...
    public MemberResDto getMember(Long memberId) {
        ...
        ImageResDto imageResponseDto = null;
        if (image != null) {
            imageResponseDto = new ImageResDto(
                    image.getId(),
    ...
    // 사용자 수정
    @Transactional
    public MemberResDto updateMember(Long memberId, String name, String email, MultipartFile newImageFile) {
